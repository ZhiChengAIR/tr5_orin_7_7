...
int main(int argc, char **argv) {
    ...
    PVT_Ctr pvtCtr(dt,"/home/zjy/tr5_test/src/tr5_demo_test/src/joint_ctrl_config.json");
    FootPlacement footPlacement; // foot-placement planner
    JoyStickInterpreter jsInterp(dt);
    DataLogger logger("/home/zjy/tr5_test/src/tr5_demo_test/record/datalog_local.log"); // data logger
    CSVInputLoader loader("/home/zjy/tr5_test/mujoco_log_new.csv", 30);
